class BankAccount:
    ...
    def __del__(self):
        print(f"Bank account with account number {self.account_number} is destroyed.")
...
class Customer:
    ...
    def __del__(self):
        print(f"Customer '{self.name}' with bank account number {self.bank_account.account_number} is destroyed.")
